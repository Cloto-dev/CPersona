...
@pytest.mark.asyncio
async def test_schema_version_constant_is_12():
    """The migration target constant must be 12 (v12 = UNIQUE dedup indexes, bug-010)."""
...
async def test_fresh_db_creates_current_schema():
    ...
    async with _TempDB() as tmp:
        ...
        assert await _schema_version(db) == 12
