...
@pytest.mark.asyncio
async def test_schema_version_constant_is_13():
    """The migration target constant must be 13 (v13 = column-scoped FTS AU triggers, bug-012)."""
...
async def test_fresh_db_creates_current_schema():
    ...
    async with _TempDB() as tmp:
        ...
        assert await _schema_version(db) == 13
