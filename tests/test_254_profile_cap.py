"""an earlier decision: the profile's ceiling is its own, not the memory content cap.
...
memory cap (the 2.6 tree, an earlier decision) would have put an unbounded profile into
