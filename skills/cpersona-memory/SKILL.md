...
| Group | Tools |
|-------|-------|
| Core read/write | `store`, `declare_associations`, `recall`, `recall_with_context`, `reconstruct`, `get_contents`, `list_memories`, `list_episodes` |
...
- Schema v15 (auto-migrating) · ~26,395 LOC Python across focused modules · MIT.
