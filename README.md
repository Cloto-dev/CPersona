...
Behind it: **~1,525 test functions** across ~126 test modules (~1,930 cases parametrised, more test code than server code), on **Schema v13** — [how a release is gated](https://cloto-dev.github.io/CPersona/quality-assurance/).
