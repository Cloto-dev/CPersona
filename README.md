...
Behind it: **~2,031 test functions** across ~152 test modules (~2,593 cases parametrised, more test code than server code), on **Schema v14** — [how a release is gated](https://cloto-dev.github.io/CPersona/quality-assurance/).
