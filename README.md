...
Behind it: **~1,957 test functions** across ~147 test modules (~2,504 cases parametrised, more test code than server code), on **Schema v14** — [how a release is gated](https://cloto-dev.github.io/CPersona/quality-assurance/).
