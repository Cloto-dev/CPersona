...
Behind it: **~2,258 test functions** across ~165 test modules (~2,864 cases parametrised, more test code than server code), on **Schema v16** — [how a release is gated](https://cloto-dev.github.io/CPersona/quality-assurance/).
