...
Behind it: **~2,092 test functions** across ~156 test modules (~2,667 cases parametrised, more test code than server code), on **Schema v15** — [how a release is gated](https://cloto-dev.github.io/CPersona/quality-assurance/).
