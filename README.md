...
Behind it: **~2,278 test functions** across ~166 test modules (~2,891 cases parametrised, more test code than server code), on **Schema v16** — [how a release is gated](https://cloto-dev.github.io/CPersona/quality-assurance/).
