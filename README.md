...
Behind it: **~1,579 test functions** across ~129 test modules (~2,010 cases parametrised, more test code than server code), on **Schema v13** — [how a release is gated](https://cloto-dev.github.io/CPersona/quality-assurance/).
