...
Behind it: **~2,169 test functions** across ~161 test modules (~2,764 cases parametrised, more test code than server code), on **Schema v16** — [how a release is gated](https://cloto-dev.github.io/CPersona/quality-assurance/).
