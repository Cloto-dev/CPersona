...
Behind it: **~1,670 test functions** across ~134 test modules (~2,356 cases parametrised, more test code than server code), on **Schema v13** — [how a release is gated](https://cloto-dev.github.io/CPersona/quality-assurance/).
