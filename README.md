...
Behind it: **~2,572 test functions** across ~183 test modules (~3,309 cases parametrised, more test code than server code), on **Schema v17** — [how a release is gated](https://cloto-dev.github.io/CPersona/quality-assurance/).
