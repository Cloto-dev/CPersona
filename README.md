...
Behind it: **~1,505 test functions** across ~125 test modules (~1,910 cases parametrised, more test code than server code), on **Schema v13** — [how a release is gated](https://cloto-dev.github.io/CPersona/quality-assurance/).
