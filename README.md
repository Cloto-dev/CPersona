...
- **~10,700 LOC** Python across focused modules, plus a 3,300-line vendored MCP
  common snapshot
- **677 test functions** across 59 test modules — 818 cases once the
...
(latest v2.4.40) and **2.5.x is the Current line** (latest v2.5.3), where all
