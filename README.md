...
Behind it: **~2,444 test functions** across ~176 test modules (~3,096 cases parametrised, more test code than server code), on **Schema v17** — [how a release is gated](https://cloto-dev.github.io/CPersona/quality-assurance/).
