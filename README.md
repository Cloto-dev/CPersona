...
Behind it: **~1,922 test functions** across ~142 test modules (~2,453 cases parametrised, more test code than server code), on **Schema v13** — [how a release is gated](https://cloto-dev.github.io/CPersona/quality-assurance/).
