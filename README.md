...
Behind it: **~2,506 test functions** across ~179 test modules (~3,199 cases parametrised, more test code than server code), on **Schema v17** — [how a release is gated](https://cloto-dev.github.io/CPersona/quality-assurance/).
