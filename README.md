...
Behind it: **~2,363 test functions** across ~170 test modules (~2,996 cases parametrised, more test code than server code), on **Schema v17** — [how a release is gated](https://cloto-dev.github.io/CPersona/quality-assurance/).
