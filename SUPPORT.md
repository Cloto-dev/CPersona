...
| 2.6.x | **Experimental** | — | — | Opt-in alpha releases. The first increment improves FTS query punctuation handling; it is not the complete 2.6 roadmap. The 2.5.x maintenance branch and production soak remain separate. |
