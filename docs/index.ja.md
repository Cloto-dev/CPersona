...
ありません。進捗はリリースノートと SUPPORT.md にあります。2.6 系には専用ページ
[Reliable Recall](RELIABLE_RECALL_2_6.md) があります: 1 回の呼び出しの中で反復する
想起プロセス、手がかりの契約、1 つの prior 関数、再構成の出口とその件数の窓、失敗の分類、
そして「完了」の意味。
