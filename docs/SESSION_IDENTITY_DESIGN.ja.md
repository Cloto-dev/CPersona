<!-- i18n-source: docs/SESSION_IDENTITY_DESIGN.md@blob:34f4cb435bc67551061945239ed5f98b464cebed -->
...
ツール契約の破壊。したがって同系列の新しい pre-release として出荷し、final の前に soak
します。別のコードが soak した graduation に相乗りすることはしません。

ここから 2 つの帰結が出ます。どちらも省略できません:

- 系列の到達点は依然として `2.5.7` final であり、別の番号へ飛びません。ladder が完了した
