<!-- i18n-source: docs/quality-assurance.md@blob:aaa095524564897c643444ef83e77f94d373c9e7 -->
...
- **~1,256 test functions** / ~107 test modules — 挙動マトリクスをパラメータ化すると ~1,590 cases (~36,450 LOC、サーバーコードよりテストコードの方が多い)。上記の構造強制ゲートを含む
