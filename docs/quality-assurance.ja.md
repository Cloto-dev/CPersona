<!-- i18n-source: docs/quality-assurance.md@blob:33df0ed90e899f9aebbaac4b0abcd970239da815 -->
...
- **~1,240 test functions** / ~104 test modules — 挙動マトリクスをパラメータ化すると ~1,570 cases (~35,000 LOC、サーバーコードよりテストコードの方が多い)。上記の構造強制ゲートを含む
