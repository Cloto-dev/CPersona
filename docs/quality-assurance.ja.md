<!-- i18n-source: docs/quality-assurance.md@blob:cad8e6b729f78c588e255ab2c9da58d7890e8965 -->
...
- **~1,210 test functions** / ~100 test modules — 挙動マトリクスをパラメータ化すると ~1,530 cases (~35,000 LOC、サーバーコードよりテストコードの方が多い)。上記の構造強制ゲートを含む
