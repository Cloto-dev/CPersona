<!-- i18n-source: docs/quality-assurance.md@blob:d39e40315e76b8daf6b67110d50370e196cf911c -->
...
- **~1,195 test functions** / ~99 test modules — 挙動マトリクスをパラメータ化すると ~1,520 cases (~33,800 LOC、サーバーコードよりテストコードの方が多い)。上記の構造強制ゲートを含む
