<!-- i18n-source: docs/quality-assurance.md@blob:9c30fb7753bf2425aa69dfeb7f0583615d1f23e7 -->
...
- **~1,670 test functions** / ~134 test modules — 挙動マトリクスをパラメータ化すると ~2,283 cases (~51,675 LOC、サーバーコードよりテストコードの方が多い)。上記の構造強制ゲートを含む
