<!-- i18n-source: docs/quality-assurance.md@blob:4c040a872d37fe576cb4a095e346e692b5179838 -->
...
- **~18,700 LOC** の Python (機能ごとに分割されたモジュール群)、加えて 3,450 行の vendored MCP common スナップショット
