<!-- i18n-source: docs/quality-assurance.md@blob:27442a0156af30d6e7f701fbad599302e927f4bb -->
...
- **~950 test functions** / ~86 test modules — 挙動マトリクスをパラメータ化すると ~1,190 cases (~28,900 LOC、サーバーコードよりテストコードの方が多い)。上記の構造強制ゲートを含む
