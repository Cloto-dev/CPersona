<!-- i18n-source: docs/quality-assurance.md@blob:6b6fd33b4e28ffbb5d6023b3debfb3f96a6b7836 -->
...
- **~14,100 LOC** の Python (機能ごとに分割されたモジュール群)、加えて 3,300 行の vendored MCP common スナップショット
