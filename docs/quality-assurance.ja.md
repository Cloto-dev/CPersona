<!-- i18n-source: docs/quality-assurance.md@blob:a1a5a5454b46c1deca760c3fb22c0188994e875b -->
...
- **~1,862 test functions** / ~136 test modules — 挙動マトリクスをパラメータ化すると ~2,476 cases (~54,953 LOC、サーバーコードよりテストコードの方が多い)。上記の構造強制ゲートを含む
