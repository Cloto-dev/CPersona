<!-- i18n-source: docs/quality-assurance.md@blob:87c7064faa95bf960749d6ddcfb03fca4c41fb1f -->
...
- **~20,700 LOC** の Python (機能ごとに分割されたモジュール群)、加えて 3,450 行の vendored MCP common スナップショット
