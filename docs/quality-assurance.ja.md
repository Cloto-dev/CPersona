<!-- i18n-source: docs/quality-assurance.md@blob:015854d0d1fbc8df18512e5c04629a25b8259f9a -->
...
- **~980 test functions** / ~89 test modules — 挙動マトリクスをパラメータ化すると ~1,230 cases (~29,600 LOC、サーバーコードよりテストコードの方が多い)。上記の構造強制ゲートを含む
