<!-- i18n-source: docs/quality-assurance.md@blob:4a2977ea0f9341f08241c6478516a5ac85cf5709 -->
...
- **~1,350 test functions** / ~114 test modules — 挙動マトリクスをパラメータ化すると ~1,700 cases (~39,100 LOC、サーバーコードよりテストコードの方が多い)。上記の構造強制ゲートを含む
