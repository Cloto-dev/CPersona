<!-- i18n-source: docs/quality-assurance.md@blob:ae8854725d0a24606eb15d5801500767fa84796e -->
...
- **~1,615 test functions** / ~133 test modules — 挙動マトリクスをパラメータ化すると ~2,060 cases (~47,850 LOC、サーバーコードよりテストコードの方が多い)。上記の構造強制ゲートを含む
