<!-- i18n-source: docs/quality-assurance.md@blob:4c36953f09741d51495ab381a476bbb97d922668 -->
...
- **~16,700 LOC** の Python (機能ごとに分割されたモジュール群)、加えて 3,300 行の vendored MCP common スナップショット
