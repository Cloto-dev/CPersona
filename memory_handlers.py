...
def _apply_quality_gate(
    ...
    v2.4.26 (an earlier decision): ``fused_gate`` is the calibrated post-fusion operating point.
...
async def do_recall(
    ...
    # v2.4.26 (an earlier decision): use the calibrated post-fusion gate when its calibration mode
